...
const char* mqtt_server = "104.55.7.237";
...
if (error) {
  ...
  Serial.print("JSON parsing SUCCESS!!!");
}
  

int node = doc["node"]; // 1
int garage = doc["garage"]; // 4
int status = doc["status"]; // 2184
long timestamp = doc["timestamp"]; // 1638324944
